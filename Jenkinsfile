pipeline {
    ...
    steps {
        ...
        bat 'docker run --rm -v "C:\ProgramData\Jenkins\.jenkins\workspace\SanityCheckScripts:/workspace" -w "/workspace" sanity-python:latest pylint *.py > reports/pylint_report.txt || true'
    }
}
